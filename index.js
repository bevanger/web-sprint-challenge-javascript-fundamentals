...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
/*The nested function can access the variable internal because it is function scoped. This means that we are able to use variables inside the function anywhere within our function.*/
...
const zooAnimals = [
  ...
  */
  ...
  const newArray = name.map(function(item){
  ...
  */
  ...
  function lowPopulationAnimals(pop){
  const population = pop.filter(function(item){
...
CuboidMaker.prototype.surfaceArea = function(){
  return 2 * this.length * this.width * this.width;
}
